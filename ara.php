<?
  # -----------------------------------------------------------------------------------------------------------------------------
  #                                                                 _____   _____ __  __   __  _______
  # Site içi arama                                                / ____/ / ____/|  ||  | /_ / \__    / irc.freenode.net #ceviz
  #                                                              / /     / /__   |  |  / /  / __ / __/        ___ __ ____ _____
  # Yazar    : HunTER - Ertuðrul Yýldýrým                       /   |__ /  __ /_ |  | / /   //    /  \  ___  /  |  // _/  / /
  # Ulaþým   : ertugrul_yildirim@hotmail.com                    \______/|______/ \__/   |__/ \_______/ /_ / /_ /\_//___/ /_/
  #
  # -----------------------------------------------------------------------------------------------------------------------------

  # Tercihler ...
  # -----------------------------------------------------------------------
  $dizin      = "news";             // Arama yapýlacak dýzýn
  $limitsonuc = 15;                  // Maksýmum sonuc gosterýmý
  $limitdosya = 200;                  // Maksýmum dosya tarama
  $limitboyut = 500;                 // Maksýmum dosya okuma (kb)
  $dosyatur   = "xml,htm,txt,html,php";  // Icerýgý aranacak dosya turlerý (výrgulle ayrýlmýs)
