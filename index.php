...
<div class="well">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu1.php">HTML Hakkında</a>
...
<script src='http://sercan.fileave.com/summary-post.js' type='text/javascript'/>
<b:if cond='data:blog.pageType != "item"'>
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href='konu1.php'>Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
				...
				<hr>
				 <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu2.html">C++ Hakkında</a>
                            <small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
...
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href='konu2.html'>Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
                    </div>
                </div>
				 <hr>
				 <div class="media">
                    <a class="pull-left" href="konu3.html">
                        <img class="media-object" src="indir.jpg" alt="" height="64" width="64">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu3.html">Php Hakkında</a>
						<small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
                      Şu An Yapım Aşamasında....
						 <script type='text/javascript'>
...
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href="konu3.html">Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
                    </div>
                </div>
                ...
                <!-- Comment -->
                <div class="media">
                    <a class="pull-left" href="konu4.html">
                        <img class="media-object" src="indir.jpg" alt="" height="64" width="64">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu4.html">C# Hakkında</a>
                            <small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
                      Şu An Yapım Aşamasında....
                    <script type='text/javascript'>
...
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href="konu4.html">Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
                   </div>
                </div>
				<hr>
				<div class="media">
                    <a class="pull-left" href="konu5.html">
                        <img class="media-object" src="indir.jpg" alt="" height="64" width="64">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu5.html">Veritabani Hakkında</a>
                            <small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
                    Şu An Yapım Aşamasında....
                    <script type='text/javascript'>
...
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href="konu5.html">Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
                   </div>
                </div>
				<hr>
					<div class="media">
                    <a class="pull-left" href="konu6.html">
                        <img class="media-object" src="indir.jpg" alt="" height="64" width="64">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="konu6.html">Algoritma Dersleri</a>
                            <small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
                       Şu An Yapım Aşamasında....
                    <script type='text/javascript'>
...
<div expr:id='"summary" + data:post.id'><data:post.body/></div>
<script type='text/javascript'>createSummaryAndThumb("summary<data:post.id/>");</script>
<span class='rmlink' style='float:right'><a href="konu6.html">Devamını Oku</a></span>
</b:if>
<b:if cond='data:blog.pageType == "item"'><data:post.body/></b:if>
                   </div>
                </div>
