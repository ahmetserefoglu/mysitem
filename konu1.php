...
<div class="well">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>HTML Hakkında</a>
                            <small><?php echo date('d.m.Y H:i:s'); ?></small>
                        </h4>
                      <h1> HTML dosyası nedir?<h1>

<ul><li><i>HTML'in açılımı Hyper Text Markup Language (Bunun tam Türkçe'si bulunmamakla beraber "çok yere açılan metin" denebilir.</i>
<li><i>Bir HTML dosyası bir text dosyası olmakla beraber markup tags (işaretlenmiş etiketler) içerir
<li>Markup tag'ler web tarayıcınıza sayfanın nasıl gösterileceğini gösterir.
<li>Bir HTML dosyasının uzantısı htm veya html olmak zorundadır.
<li>Bir HTML dosyası basit bir text editör ile oluşturulabilir.
<li>Denemek İster misiniz?
<li>Eğer Windows kullanıyorsanız not defterini açın.
<li>Eğer MAC kullanıyorsanız SimpleText programını açın.

<li>Eğer OSX kullanıyorsanız, TextEdit'i açın ve aşağıdakileri yapın: "Format" menüsünü açın ve "Rich Text" yerine "Plain Text" seçeneğini seçin. Sonra "Text Edit" menüsünün altında bulunan "Preferences" penceresini açın ve "Ignore rich text commands in HTML files" seçeneğini seçin. Eğer bu değişiklikleri yapmazsanız HTML dosyasınız büyük ihtimalle çalışmayacaktır!
</ul>
