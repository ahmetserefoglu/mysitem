...
<div class="well">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>Kablosuz Sensör Ağlarının Optimizasyon Algoritması(C#) </a>
                            
                        </h4>
                       <i>Bu çalışmada eldeki sınırlı sayıda algılayıcı düğüm ile en iyi yayılımı sağlayarak algılayıcı ağının kapsama alanını arttırmaya yönelik algılayıcı yerleştirme probleminin genetik algoritma ile çözülmesi amaçlanmıştır. Çözümünde çok sayıda uygulama alanında kullanılan ve uygun ayarlamalarda da başarılı sonuçları kısa sürede üretebilen sezgisel yöntemlerden biri olan genetik algoritma kullanılmıştır.Bu çalışmada C# programlama dili kullanılmıştır.Özellikle güvenliği sağlamak için önemli bir yere sahip olan sensör yerleştirme probleminin genetik algoritma uygulaması geliştirilmiş ve sonuçları analiz edilmiştir.</i>
                    </div>
                </div>
				<hr>
				 <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>Öğrenci Takip Sistemi(Android-Php) </a>
                           
                        </h4>
                       <i>Bu çalışmada üniversite ortamında öğretmen-öğrenci ilişkilerinde iletişim sorunlarından kaynaklanan sebeplerden düşünülerek geliştirilmiş projedir.Projemizde android işletim sistemine sahip cihazlardan öğrenciler sisteme kayıt olacak ve admin tarafıından öğrenci olduğu kanıtlandıktan sonra öğretmenlerin sisteme girdikleri uygun zamanlarına göre hocalar ile maksimum 30 dk görüşmek için randevu alacak ve hoca sistemi üzerinde görülecek ve onay verilecektir.Bu çalışma android cihazları olmayan öğrenciler için alternatif yöntem olarak web üzerinden iletişim sağlayacaktır ve randevuyu oradan alacaktır.</i>
                    </div>
                </div>
				 <hr>
				 <div class="media">
                    <a class="pull-left" href="konu.html">
                        <img class="media-object" src="indir.jpg" alt="" height="64" width="64">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a>Yapay Zeka-Arduino Araç Kontrolü(Arduino-C#) </a>
					
                        </h4>
                        <i>Bu projede, tasarımı yapılan robot ile üzerine yerleştirdiğimiz arduino, uzaklık sensörü,dc motor ile robotun kapalı bir ortamda herhangi bir yere çarpmadan hareket etmesi sağlanmıştır.Robot üzerine yerleştirilen kamera ile etrafın görüntüsü android cihaza aktarılmıştır ve kontrolü android cihazdan wifi üzerinden hareketi sağlanmıştır.Bu proje gruplar halinde parçalara ayrılarak yapılmıştır.</i>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>Kablosuz Sensör Ağları İle Okul Güvenliğinin Sağlanması(Matlab) </a>
                           
                        </h4>
                        <i>Bu çalışmada son yılların önemli teknolojilerinden biri olan kablosuz algılayıcı(sensör) ağların doğasında ve uygulamasında yer alan birçok eniyileme problemi tanıtılmış ve problemlerden algılayıcı yerleştirme probleminin farklı amaçlara sahip çözüm yöntemi geliştirilmiştir.Problem, alan öncelikli ortamlarda algılayıcı yerleştirmesidir. Kablosuz algılayıcı ağlarından algılayıcı yerleşimi için alan önceliği kavramı ve problemin farklı özelliklere sahip uygun olmayan zeminlere uygun hale getirilmesi sağlanacaktır.Bu proje için ilk olarak sensörlerin yerleştirilmesi problemi genetik algoritma yöntemi ile çözüm geliştirilmiş ve yüzde 60 oranında probleme cevap verilmiştir.</i>
				...
				<div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>Üniversite Duyuru Panosu(Php) </a>
                            
                        </h4>
                       <i>Bu çalışmada, öğrenci ile öğretim elemanı arasında internet üzerinden  iletişimi, ödev iletimi-kontrolünü, ders doküman paylaşımı ve güncel  duyuruların paylaşımını sağlamaktadır.
					   </i>
				...
				<hr>
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><a>Yapay Zeka-Otomobil Satış Tahmini(Matlab) </a>
                         
                        </h4>
                        <i>Talep tahmini tüketicilerin gelecekte ne kadar mal ve hizmet talep edeceklerinin değişkenler yardımıyla tahmin edilmesidir. Talep tahmin metotları sezgisel ve sayısal yöntemler olmak üzere iki grupta toplanmaktadır. Bu çalışmanın amacı da yeni otomobil satış miktarlarının yapay sinir ağları yöntemiyle önceden tahmin edilerek otomotiv sektörü ile ilgili bir takım politikaların belirlenmesine katkı sağlamaktır.</i>
                    
                   </div>
                </div>
				<hr>
				<div class="well">
				<i>Projelerimin Tamamına <a href="https://github.com/ahmetserefoglu?tab=repositories ulaşabilirsiniz">Github </a>adresinden ulaşabilirsiniz.</i>
				</div>
